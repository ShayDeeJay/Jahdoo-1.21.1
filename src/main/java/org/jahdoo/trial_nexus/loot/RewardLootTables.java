...
public class RewardLootTables {
    ...
    public static ObjectArrayList<ItemStack> getCompletionLoot(
        ...
        for (var lootParam : lootParams) {
            EnchantHelpers.randomApplicableEnchantment(lootParam);
        }
        return lootParams;
    }
    ...
    private static LootPool.Builder singlePoolBuilder(InstanceDifficulty difficulty, int chestRarity) {
        ...
        if(newRarity >=2){
            ...
            if(MathHelpers.percentageChance(calculateChance(30, difficulty, newRarity))){
        ...
        if(newRarity >= 3){
            ...
            if(MathHelpers.percentageChance(calculateChance(20, difficulty, newRarity))){
        ...
        if(MathHelpers.percentageChance(calculateChance(15, difficulty, newRarity))){
        ...
        if(MathHelpers.percentageChance(calculateChance(8, difficulty, newRarity))){
        ...
        if(MathHelpers.percentageChance(calculateChance(1.5, difficulty, newRarity))){
            addWizardArmor(builder, newRarity);
        }

        if(MathHelpers.percentageChance(calculateChance(0.5, difficulty, newRarity))){
