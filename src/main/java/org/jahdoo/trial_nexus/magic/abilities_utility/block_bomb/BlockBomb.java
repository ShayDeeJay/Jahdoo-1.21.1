package org.jahdoo.trial_nexus.magic.abilities_utility.block_bomb;
...
import static org.jahdoo.trial_nexus.magic.UtilityHelpers.destroySpeed;
import static org.jahdoo.trial_nexus.magic.abilities_utility.block_bomb.BlockBombAbility.EXPLOSION_RANGE;
...
//        this.blockDropChance = (int) this.getTag(BLOCK_DROP_CHANCE);
    ...
    public void sharedSound(SoundEvent sEvent, Float volume, Float pitch){
        SoundHelpers.getSoundWithPosition(level(), generic.blockPosition(), sEvent, SoundSource.NEUTRAL, volume, pitch);
    }
