...
public class KeyBinding {
    ...
    public static final String POCKET_DIM = "key.assets.jahdoo.pocket_dimension";
    public static final String BLINK_KEY = "key.assets.jahdoo.blink";
    public static final String RUSH_KEY = "key.assets.jahdoo.rush";
    ...
    public static final KeyMapping POCKET_DIMENSION = map(POCKET_DIM);
    public static final KeyMapping BLINK = map(BLINK_KEY);
    public static final KeyMapping RUSH = map(RUSH_KEY);
