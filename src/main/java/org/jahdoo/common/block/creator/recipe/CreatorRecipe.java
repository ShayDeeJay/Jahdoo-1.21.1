...
public class CreatorRecipe implements Recipe<RecipeInput> {
    ...
    private ItemStack randomAugment(){
        var stack = new ItemStack(ItemReg.AUGMENT_CORE);
        return stack;
    }

    public ItemStack getOutputItemWithData(){
        var asItem = this.output;
//        if(asItem.is(ItemReg.AUGMENT_CORE)){
//            var stack = new ItemStack(ItemReg.AUGMENT_CORE);
//            CoreData.setFilled(stack);
//            return stack;
//        }
