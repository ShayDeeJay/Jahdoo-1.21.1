...
public class RecipeRegistry {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<CreatorRecipe>> CREATOR_TYPE = RECIPE_TYPES.register(CREATOR_RECIPE_ID, () -> RecipeType.simple(Helpers.res(CREATOR_RECIPE_ID)));
