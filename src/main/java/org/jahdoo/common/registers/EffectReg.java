...
import org.jahdoo.trial_nexus.magic.effects.type_effects.frost.FrostEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.frost.FrostStormEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.frost.GreaterFrostEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.inferno.GreaterInfernoEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.inferno.InfernoEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.mystic.GreaterMysticEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.mystic.MysticEffect;
import org.jahdoo.trial_nexus.magic.effects.type_effects.vitality.GreaterVitalityEffect;
...
public class EffectReg {
    ...
    public static Optional<MobEffect> getByName(String name){
        return MOB_EFFECTS.getRegistry().get().stream().filter(a -> a.getDescriptionId().equals(name)).findFirst();
    }
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public static final DeferredHolder<MobEffect, MobEffect> FROST_STORM_RUSH =
        mobEffect("frost_storm_rush", FrostStormEffect::new);
