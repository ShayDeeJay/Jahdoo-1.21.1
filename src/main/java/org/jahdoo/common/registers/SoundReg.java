...
public class SoundReg {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> LOOTBOX_IDLE =
        registerSoundEvent("lootbox_idle");

    public static final DeferredHolder<SoundEvent, SoundEvent> LOOTBOX_OPEN =
        registerSoundEvent("lootbox_open");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> QUEST_COMPLETE =
        registerSoundEvent("quest_complete");
    ...
    private static DeferredHolder<SoundEvent, SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(JahdooHelpers.res(name)));
    }
}
