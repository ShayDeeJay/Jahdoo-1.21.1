...
public class ParticleReg {
    ...
    public static final Supplier<ParticleType<GenericParticleOptions>> MAGIC =
        register("magic", GenericParticleOptions.MAP_CODEC, GenericParticleOptions.STREAM_CODEC);
    ...
    public static final Supplier<ParticleType<GenericParticleOptions>> MAGIC_MOVE =
        register("magic_move", GenericParticleOptions.MAP_CODEC, GenericParticleOptions.STREAM_CODEC);

    public static final Supplier<ParticleType<GenericParticleOptions>> SOFT_MOVE =
        register("soft_move", GenericParticleOptions.MAP_CODEC, GenericParticleOptions.STREAM_CODEC);

    public static final Supplier<ParticleType<GenericParticleOptions>> GENERIC_MOVE =
        register("generic_move", GenericParticleOptions.MAP_CODEC, GenericParticleOptions.STREAM_CODEC);
    ...
    public static final Supplier<ParticleType<BakedParticleOptions>> BAKED_FROST =
        register("baked_frost", BakedParticleOptions.MAP_CODEC, BakedParticleOptions.STREAM_CODEC);

    public static final Supplier<ParticleType<BakedParticleOptions>> BAKED_MYSTIC =
        register("baked_mystic", BakedParticleOptions.MAP_CODEC, BakedParticleOptions.STREAM_CODEC);

    public static final Supplier<ParticleType<BakedParticleOptions>> BAKED_VITALITY =
        register("baked_vitality", BakedParticleOptions.MAP_CODEC, BakedParticleOptions.STREAM_CODEC);

    public static final Supplier<ParticleType<BakedParticleOptions>> BAKED_UTILITY =
        register("baked_utility", BakedParticleOptions.MAP_CODEC, BakedParticleOptions.STREAM_CODEC);

    public static final Supplier<ParticleType<BakedParticleOptions>> HEAL =
        register("heal", BakedParticleOptions.MAP_CODEC, BakedParticleOptions.STREAM_CODEC);
