    ...
    public static class RookieAssassinAdvancement implements AdvancementGenerator{
        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
            ...
            Advancement.Builder.advancement()
                .display(new ItemStack(Items.ROTTEN_FLESH), Helpers.withStyleComponent(rookie.taskName(), ColourStore.RATING_4_YELLOW), Helpers.withStyleComponent(rookie.taskDescription(), ColourStore.GOLD_COIN), null, AdvancementType.CHALLENGE, true, true, false)
