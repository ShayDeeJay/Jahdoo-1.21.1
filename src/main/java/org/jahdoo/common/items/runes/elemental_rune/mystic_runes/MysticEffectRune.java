...
public class MysticEffectRune extends AbstractMysticRune {

    @Override
    public Holder<Attribute> attributeHolder() {
        return AttributeReg.MYSTIC_EFFECT_EXPLOSION_CHANCE;
    }
    ...
    public double getAttribute(RarityAttributes rarityAttributes) {
        return rarityAttributes.getRandomManaRegen() * 2;
    }
