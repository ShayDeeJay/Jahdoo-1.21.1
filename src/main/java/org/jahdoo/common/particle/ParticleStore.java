...
public record ParticleStore(int r, int g, int b){
    ...
    public static final int SQUARE_PARTICLE = 9;
    ...
    public static final List<ParticleType<?>> getColouredParticle = List.of(
        GENERIC.get(), MAGIC.get(), SOFT.get(), ELECTRIC.get(), PLUS.get(), ENCHANT.get(), MAGIC_MOVE.get(), GENERIC_MOVE.get(), SOFT_MOVE.get(), SQUARE.get()
    );
