...
public class KeyBinding {
    ...
    public static final String TARGET_LOCK = "key.assets.jahdoo.target_lock";
    ...
    public static final KeyMapping TARGET_LOCK_A = new KeyMapping(TARGET_LOCK, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_UNKNOWN, JAHDOO_CUSTOM_BIND);
