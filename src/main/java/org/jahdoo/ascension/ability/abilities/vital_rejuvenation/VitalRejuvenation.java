...
public class VitalRejuvenation extends AbstractHoldUseAttachment {
    ...
    private void unSuccessfulCast(Player player) {
        Helpers.getSoundWithPosition(player.level(), player.blockPosition(), SoundRegister.HEAL.get(), 0.8f, 0.8f);
    ...
    public static void successfulCastAnimation(LivingEntity player) {
        ...
        Helpers.getSoundWithPosition(player.level(), player.blockPosition(), SoundRegister.HEAL.get(), 1f,1f);
