...
public class FrostBolts  extends DefaultEntityBehaviour {
    ...
    public void onEntityHit(LivingEntity hitEntity) {
        ...
        if (player.isCloseEnough(hitEntity,castDistance + 0.1)) {
            ...
            Helpers.getSoundWithPositionV(genericProjectile.level(), hitEntity.position(), SoundRegister.ORB_CREATE.get(), 2f, 1f);
    ...
    private void shootArrowsAtTarget(LivingEntity hitEntity, Player player, int tickCount){
        ...
        if(tickCount % 2 == 0){
            ...
            Helpers.getSoundWithPosition(genericProjectile.level(), hitEntity.blockPosition(), SoundEvents.BREEZE_SHOOT, 0.4f, 2f);
            Helpers.getSoundWithPosition(genericProjectile.level(), hitEntity.blockPosition(), SoundRegister.ORB_CREATE.get(), 0.2f, 1.8f);
        }
    }
    ...
    ResourceLocation abilityId = Helpers.res("frost_bolts_property");
