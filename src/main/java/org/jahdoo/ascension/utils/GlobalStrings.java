...
public class GlobalStrings {
    ...
    public static final String BLOCK_PLACER = "Can place blocks that are in your off hand. If there are blocks of the same colour in your inventory, it will prioritize placing those first.";
