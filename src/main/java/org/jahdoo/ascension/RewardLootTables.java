...
import static org.jahdoo.ascension.utils.EnchantmentHelpers.*;
...
public class RewardLootTables {
    ...
    public static final LootPoolSingletonContainer.Builder<?> AUGMENT_ITEM_BUILDER = LootItem.lootTableItem(ItemsRegister.AUGMENT.get());
    ...
    public static @NotNull ItemStack magnetItem(JahdooRarity getRarity, ItemStack itemStack) {
        ...
        var origin = id * 1000;
        Helpers.setDurability(itemStack, Random.nextInt(origin, origin * 3));
