...
//        );
    ...
    public static void debugRarity(Player player){
        if(!player.level().isClientSide){
            Helpers.playDebugMessage(player, "NEW ROLL");
            Helpers.playDebugMessage(player, "---------------------------------");
            ...
            Helpers.playDebugMessage(player, "Common " + common.get());
            Helpers.playDebugMessage(player, "Un-Common " + uncommon.get());
            Helpers.playDebugMessage(player, "Epic " + epic.get());
            Helpers.playDebugMessage(player, "Legendary " + legendary.get());
            Helpers.playDebugMessage(player, "Eternal " + ethereal.get());
            Helpers.playDebugMessage(player, "  ");
        }
    }
}
