...
import static org.jahdoo.challenge.RewardLootTables.magnetItem;
...
public record ShoppingItems(ItemStack ShoppingItem, ItemCosts itemCosts){
    ...
    public static ShoppingItems shoppingMagnetItem() {
        ...
        var magnetStack = new ItemStack(ItemsRegister.MAGNET.get());
        var getMagnet = magnetItem(getRarity, magnetStack);

        addAttribute(ElementRegistry.getRandomElement(), getMagnet);
